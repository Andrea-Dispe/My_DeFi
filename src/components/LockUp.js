      ...
      <Wrapper>
            ...
            <Card className={classes.topCard}>
              <Grid container className={classes.fullHeight}>
                <Grid container item alignItems="center">
                  ...
                  <Typography className={`${classes.topCardTitle} ${classes.leftSpace}`}> Husky {t('price')}</Typography>
                </Grid>
          ...
          <Grid item xs={6}>
            <Card className={classes.topCard}>
              <Grid container className={classes.fullHeight}>
                <Grid container item alignItems="center">
                  <Avatar src={Icons.logo}></Avatar>
                  <Typography className={`${classes.topCardTitle} ${classes.leftSpace}`}>Husky {t('locked_position')}</Typography>
                </Grid>
                <Grid container alignItems="center" justify="center" className={classes.fullHeight}>
                  <Typography variant="h4" className={classes.topCardContent}>
        ...
        <Card className={classes.card}>
          ...
          <Grid>
            ...
            <Grid container justify="space-between" wrap="nowrap">
              <Grid item container wrap="nowrap" alignItems="center" style={{width: 'auto'}}>
                <Typography className={classes.dataTitle}>HUSKY-USDT LP {t('lock-up')}</Typography>
                <img src={excl} className={classes.leftSpace} alt="exclamation point icon" />
              </Grid>

              <Grid item >
                <Typography className={classes.dataTitle}>256987 HUSKY/{t('released_today')}</Typography>
              </Grid>
            </Grid>
            <Divider className={classes.divider} />
          </Grid>
          ...
          <Grid container wrap="nowrap" className={classes.dataContainer}>
            ...
            <Grid container item direction="column" alignItems="center">
              <Typography className={classes.dataTitle}>{t('locked_up_amount')} (HUSKY-USDT LP)</Typography>
          ...
          <Grid className={classes.actionContainer}>
            <Divider className={classes.divider} />
            <Typography className={classes.dataTitle}>{t('get')} HUSKY-USDT LP</Typography>
            <Divider className={classes.divider} />
          ...
          <Grid container wrap="nowrap" className={classes.dataContainer}>
            ...
            <Grid container item direction="column" alignItems="center">
              <Typography className={classes.dataTitle}>{t('locked_up_amount')} (HUSKY-BNB LP)</Typography>
              <Typography variant="h4" className={classes.lightOrange}>
                <span className={`${classes.smallText} ${classes.symbolLeftSpace}`}>$</span>
                58.36
                <span className={`${classes.smallText} ${classes.symbolLeftSpace}`}>M</span>
        ...
        <Card className={classes.card}>
          ...
          <Grid className={classes.containerTopSpace}>
            ...
            <Grid container justify="space-between">
              <Typography className={classes.dataTitle}>HUSKY {t('lock-up')}</Typography>
              <Typography className={classes.dataTitle}>256987 HUSKY/{t('released_today')}</Typography>
          ...
          <Grid container wrap="nowrap" className={classes.dataContainer}>
            <Grid container item direction="column" alignItems="center">
              <Typography className={classes.dataTitle}>{t('locked_position')} (Husky)</Typography>
              <Typography variant="h4" className={classes.lightOrange}>
            ...
            <Grid container item direction="column" alignItems="center">
              <Typography className={classes.dataTitle}>{t('locked_up_amount')} (Husky)</Typography>
              <Typography variant="h4" className={classes.lightOrange}>
                <span className={`${classes.smallText} ${classes.symbolLeftSpace}`}>$</span>
                58.36
                <span className={`${classes.smallText} ${classes.symbolLeftSpace}`}>M</span>
